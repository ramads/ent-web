...
<head>
    ...
    <title>Login - Smart ENT UNRAM</title>
...
<div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
    <div class="fixed top-0 hidden p-6 lg:block lg:px-12">
        <a href="#" class="flex items-center space-x-2">
            <img class="size-12" src="<?php assets(); ?>images/app-logo.png" alt="logo">
            <p class="text-xl font-semibold uppercase text-slate-900 dark:text-navy-100">
                Smart ENT
            </p>
        </a>
    </div>
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-lg p-6">
            <img class="w-full" x-show="!$store.global.isDarkModeEnabled" src="<?php assets(); ?>images/illustrations/dashboard-check.svg" alt="image">
            <img class="w-full" x-show="$store.global.isDarkModeEnabled" src="<?php assets(); ?>images/illustrations/dashboard-check-dark.svg" alt="image">
        </div>
    </div>
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                <img class="mx-auto size-16 lg:hidden" src="<?php assets(); ?>images/app-logo.png" alt="logo">
                <div class="mt-4">
            ...
            <div class="mt-16">
                ...
                <button class="btn mt-10 h-10 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"
                        onclick="location.href='<?php echo base_url();?>index.php/doLogin'">
                    Sign In
                </button>
            </div>
        </div>
